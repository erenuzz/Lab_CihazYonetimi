...
{
    [DbContext(typeof(veritabanı sınıfı))]
    partial class ProtaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.KullaniciveMentorEgitimleri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MentorEgitimleriId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MentorEgitimleriId");

                    b.ToTable("kullaniciveMentorEgitimleris");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.KullaniciveMentorEgitimleri", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.MentorEgitimleri", "MentorEgitimleri")
                        .WithMany()
                        .HasForeignKey("MentorEgitimleriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("MentorEgitimleri");
                });
